...
<body>
    ...
    <div class="food-search">
        <div class="container">
                <input type="serach" name = "search" placeholder="Search for Food..">
                <input type="submit" name= "submit" value="search">
        </div>
    </div>
    <div class="categories">
        <div class="container" >
            <h2> <a href="./explore.php"> Explore Foods </a></h2>
            <div class="explore">
                ...
                <div class="list-explore">
                    <img src="../imgs/burger.jpg" alt="burger">
                    <h4>burger</h4>
                </div>
                <div class="list-explore">
                    <img src="../imgs/momo.jpg" alt="momo">
                    <h4>momo</h4>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class = "Lists">
                ...
                <div>
                    <h4>Food Title</h4>
                    <h4>$2.3</h4>
                    <p>Make with Italian sauce</p>
                    <button><a href="./order.php">Ordder</a></button>
                </div>
                    
                </div>
                <div class="details-food">
                    <img src="../imgs/menu-momo.jpg" alt="momo">
                    <div>
                        <h4>Food Title</h4>
                        <h4>$2.3</h4>
                        <p>Make with Italian sauce</p>
                ...
                <div class="details-food">
                    <img src="../imgs/menu-pizza.jpg" alt="pizza">
                    <div>
                        <h4>Food Title</h4>
                        <h4>$2.3</h4>
                        <p>Make with Italian sauce</p>
            ...
            <a href="./menu.php">See All Foods</a>
        </div>
    </div>
